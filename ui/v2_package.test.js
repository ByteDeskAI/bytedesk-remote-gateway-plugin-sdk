...
test('v2 package exports generated contracts, descriptors and schemas', () => {
  ...
  assert.equal(webAppDescriptors.List.name, 'cmd.gateway.web-apps.v1.list')
  assert.equal(webAppDescriptors.OpenPreviewExternal.name, 'cmd.gateway.web-apps.v1.preview.open-external')
